...
const devicesNotices = {
  ...
  oven: {
    ...
    yesNotice: ` برجاء ارسال صورة لوحدة الفرن علي رقم الواتساب 01100445959`,
    noNotice: `برجاء تجهيز فتحات التهوية و معاودة الاتصال لتفعيل الأوردر`
  },
  hood: {
    question: `هل يوجد وحدة مطبخ فوق المسطح او البوتجاز`,
    yesNotice: `مراعاة الارتفاع بين الشعلات و بداية الشفاط من اسفل لا تقل عن  ٧٥ سم`,
    noNotice: `مراعاة الارتفاع بين الشعلات و بداية الشفاط من اسفل لا تقل عن  ٧٥ سم`
  },
  cooker: {

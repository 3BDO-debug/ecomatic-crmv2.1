...
const feedingSourcesNotices = {
  ...
  externalExpulsion: {
    note1: `برجاء تجهيز فتحة مدخنة دائرية بقطر ٥ بوصة علي ارتفاع لا يقل عن ٢٢٥ سم من الارض بأقرب حائط خلفه منور او مخرج `,
    note2: ` سوستة المدخنة ، سعر المتر ١٠٠ جنية و حسب المسافة من الشفاط و حتي فتحة الطرد بالحائط`,
    note3: `برجاء العلم بانه كلما زادت المسافة بين الشفاط و فتحة الطرد قلت كفاءة قدرة الشفاط والمسافة القصوي هي ٤ متر علي ان تكون مستوية وبحد اقصي عدد 2 منحني(لفة)`
  }
};
// --------------------------------------------
